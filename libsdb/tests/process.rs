...
fn test_create_breakpoint_site() {
        ...
        Process::launch(&PathBuf::from("yes"), None, true, None).expect("Process failed to launch");
    {
        assert_eq!(
            target_process
                .create_breakpoint_site(VirtAddress::new(0x1000), false, false, None)
    ...
    assert_eq!(
        target_process
            .create_breakpoint_site(VirtAddress::new(0x2000), false, false, None)
            .expect("Failed to create breakpoint site at 0x2000")
            .id()
            + 1,
        target_process
            .create_breakpoint_site(VirtAddress::new(0x3000), false, false, None)
...
fn test_breakpoint_setting() {
    ...
    let _ = target_process
        .create_breakpoint_site(load_address, true, false, None)
...
fn test_hardware_breakpoints() {
    ...
    let software_breakpoint_id = target_process
        .create_breakpoint_site(VirtAddress::new(address), true, false, None)
    ...
    let _hardware_breakpoint_id = target_process
        .create_breakpoint_site(VirtAddress::new(address), true, true, None)
        .expect("Failed to create software breakpoint")
        .id();
